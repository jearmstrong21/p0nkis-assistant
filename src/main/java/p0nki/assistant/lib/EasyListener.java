...
public class EasyListener extends ListenerAdapter {
    ...
    public EasyListener addCogs(Class<?>... classes) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        for (Class<?> clazz : classes) {
            addCogs(clazz.getConstructor().newInstance());
        }
        return this;
    }

    public void addCogs(Object... objects) {
